...
const Login = () => {
	return (
		<Flex justify="center" align="center" h="auto" minH="100vh" w="full">
			<Flex>
				<Card p={12}>
					<Flex align="center" direction="column" gap={6}>
						...
						<Flex align="center" direction="column" textAlign="center">
							<Text as="h1" fontSize="xl" fontWeight="bold" color="accent-1">
						...
						<Flex direction="column" gap={3} w={264}>
							<Button size="lg" color="accent-1" leftIcon={<Google />} onClick={() => signIn('google')}>
								Continue with Google
							</Button>

							<Button size="lg" color="accent-1">
